        ...
        <div className='bg-white shadow-md rounded-lg px-8 py-6 max-w-md'>
            ...
            <form onSubmit={onSubmitHandler}>
                <div className='mb-3 min-w-72'>
                    ...
                    <input onChange={(e)=>setEmail(e.target.value)} value={email} className='rounded-md w-full px-3 py-2 border border-gray-300 outline-none' type="email" placeholder='Địa chỉ email của bạn' required/>
                </div>
                <div className='mb-3 min-w-72'>
