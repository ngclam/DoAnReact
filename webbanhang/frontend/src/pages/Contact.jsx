  ...
  return (
    <div>
      ...
      <div className='flex flex-col justify-center items-start gap-6'>
        ...
        <p className='text-gray-500'>331 QL1A, An Phú Đông, Quận 12, Hồ Chí Minh</p>
        <p className='text-gray-500'>SĐT: 0904512575 - 0962769048 <br /> Email: contact@gmail.com</p>
        <p className='text-gray-500'></p>
        <p className='font-semibold text-xl text-gray-600'>Tuyển dụng nghề nghiệp</p>
